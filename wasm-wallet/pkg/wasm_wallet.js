...
export class WebWallet {
     ...
     * @param {string} mirstat_hex
     * @param {bigint} nonce
     * @returns {string | undefined}
     */
    build_solo_extension(mirstat_hex, nonce) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(mirstat_hex, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
            const len0 = WASM_VECTOR_LEN;
 ...
 */
export function search_nonces(mirstat_hex, target_hex, start_nonce, iterations) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(mirstat_hex, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
        const len0 = WASM_VECTOR_LEN;
