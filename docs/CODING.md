# mirstat Coding & Documentation Standards

This document defines the expected style and **mandatory formal documentation requirements** for security-critical and state-machine code in the mirstat cryptocurrency.

## 1. Philosophy

mirstat is financial software running on unreliable edge hardware with novel post-quantum cryptography and a custom state machine. Correctness is not optional.
