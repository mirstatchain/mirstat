...
// on the same swarm alongside the full /mirstat/2.0.0 binary protocol.
//
...
pub const LIGHT_PROTOCOL: StreamProtocol = StreamProtocol::new("/mirstat/light/2.0.0");
pub const LIGHT_PUSH_PROTOCOL: StreamProtocol = StreamProtocol::new("/mirstat/light-push/2.0.0");
