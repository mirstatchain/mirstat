...
impl RpcServer {
    ...
    pub async fn run(self, node_handle: NodeHandle) -> Result<()> {
        ...
        let allowed_origins = [
            ...
            "https://mirstatchain.github.io".parse::<HeaderValue>().unwrap(), 
            "https://cypherpunk.gold".parse::<HeaderValue>().unwrap(), 
            "https://www.cypherpunk.gold".parse::<HeaderValue>().unwrap(), 
            "https://mirstat.cash".parse::<HeaderValue>().unwrap(), 
            "https://www.mirstat.cash".parse::<HeaderValue>().unwrap(),
        ...
        let app = Router::new()
            ...
            .route("/mirstat.css", get(mirstat_css))   
        ...
        tracing::info!("💬 mirstat Chat available at: http://{}/chat", self.addr);
