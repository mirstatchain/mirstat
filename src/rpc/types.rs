...
/// state root and mining mirstat, and returns a ready-to-mine template.
///
/// # Example
///
/// ```json
...
///
/// The web miner searches nonces against `mining_mirstat`, then fills in
...
pub struct BlockTemplateResponse {
    /// Post-tx, post-coinbase, post-state-root mirstat to mine against (hex).
    pub mining_mirstat: String,
