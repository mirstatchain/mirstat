...
//!     `prev_mirstat`, `state_root` or reveal `salt`, all of which `search()`
...
///
/// Covers ONLY what the compact filter does not: block hashes, parent mirstats,
...
/// Heights where this hash appears as a block hash, parent mirstat, state root
