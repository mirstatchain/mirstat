...
EXTENSION_ITERS = 1_000_000  # 1 Nonce = 1 Million Hashes in mirstat
...
try:
    ...
    # 3. Print Results
    print(f"\033[1;37m=== mirstat MINING MONITOR ===\033[0m")
    ...
    print("Make sure your mirstat node is running and the RPC is listening on 127.0.0.1:8545.")
