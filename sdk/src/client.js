...
/**
 * mirstat RPC & P2P Client
 * 
 * Provides a unified interface to interact with the mirstat network.
...
export class mirstatClient {
     ...
     * # Formal Specification
     * ```text
     * post result! = { height, depth, safe_depth, mirstat, required_pow, ... }
     * ```
     */
    async getState() { 
